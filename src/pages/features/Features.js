...
export default function Features() {
  ...
  const featureArray = [
    ...
    { title: 'Create item from NFT Marketplace default collection (PSRC)', allow: [true, true, true, true] },
    ...
    { title: 'Sell item using DIA/NFT Marketplace token', allow: [true, true, true, true] },
    { title: 'Sell item using ERC-20 tokens (ESC)', allow: [false, true, true, true] },
    { title: 'Transfer item out from Nft Marketplace', allow: [false, true, true, true] },
  ...
  return (
    <RootStyle title="Features | Nft Marketplace">
