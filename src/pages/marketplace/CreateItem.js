...
export default function CreateItem() {
  ...
  return (
    <RootStyle title="CreateItem | Nft Marketplace">
            ...
            <Stack spacing={1} direction="row">
              {chainType === 'ESC' && (
                <>
                  <MintingTypeButton
                    type="PSRC"
                    description="NFT Marketplace Collection"
                    onClick={() => {
              ...
              {chainType === 'ETH' && (
                <MintingTypeButton
                  type="PSREC"
                  description="NFT Marketplace ETH Collection"
                  onClick={() => {
            ...
            <Grid container direction="column" spacing={2}>
              ...
              <Grid item xs={12}>
                <Typography variant="h4" sx={{ fontWeight: 'normal' }}>
                  ...
                  <Tooltip
                    title="Setting your asset as explicit and sensitive content, like pornography and other not safe for work (NSFW) content, will protect users with safe search while browsing Nft Marketplace"
                    arrow
                    disableInteractive
                    enterTouchDelay={0}
                  >
                  ...
                  <>
                    ...
                    <Grid item xs={12}>
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 'normal', color: 'origin.main' }}>
                        Platform fee 2%&nbsp;
                        <Tooltip
                          title="We take 2% of every transaction that happens on NFT Marketplace for providing the platform to users"
                          arrow
                          disableInteractive
                          enterTouchDelay={0}
                        >
              ...
              {(collection !== 'Choose' || (collection === 'Choose' && isGeneralCollection)) && (
                <>
                  ...
                  <Grid item xs={12}>
                    ...
                    <Divider />
                    <Typography variant="body2" sx={{ fontWeight: 'normal', color: 'origin.main' }}>
                      You will receive royalties for every secondary sales on Nft Marketplace
                    </Typography>
                  </Grid>
                </>
              )}
