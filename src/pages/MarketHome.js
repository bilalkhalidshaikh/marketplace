...
export default function MarketHome() {
  ...
  return (
    <RootStyle title="Explorer | Nft Marketplace">
      <Box
        draggable={false}
        component="img"
          ...
          <Box sx={{ flexGrow: 1, pr: { xs: 0, sm: 3, md: 4, lg: 12, xl: 15 } }}>
            <Stack sx={{ height: '100%' }}>
              <Box sx={{ flexGrow: 1 }}>
                ...
                >
                NFT marketplace can be seen as an e-commerce platform where users can create, buy and sell digital assets such as digital art, collectibles.
                </Typography>
              </Box>
        ...
        <Stack spacing={10}>
          ...
          <CardStyle>
            <Box component="div">
              ...
              <Typography variant="p" component="div" sx={{ color: 'text.secondary' }}>
                ...
                Essentials Wallet. You now have the tools you need to access NFTs with Nft Marketplace.
                <br />
                <br />
          ...
          <CardStyle>
            <Box component="div">
              ...
              <Typography variant="p" component="div" sx={{ color: 'text.secondary' }}>
                NFT Marketplace is a truly decentralized marketplace that does not rely on any central servers to facilitate the
                ...
                <br />
                <br />
                On Nft Marketplace, assets cannot be censored, blocked, or taken down, and Nft Marketplace trustless exchange protocol is
          ...
          <CardStyle>
            <Box component="div">
              ...
              <Typography variant="p" component="div" sx={{ color: 'text.secondary' }}>
                DID empowers users to become self-sovereign in the virtual and online space. On Nft Marketplace, users are
                ...
                is earned. Such trust is attributed to a known entity. With NFT Marketplace and Web3.0 the transactions are
          ...
          <CardStyle>
            {/* <Box component="div">
              ...
              <Typography variant="p" component="div" sx={{ color: 'text.secondary' }}>
                ...
                currencies for purchases on NFT Marketplace and other protocols.
                <br />
                <br />
                NFT Marketplace is built on the ESC to benefit from its efficiency and high-performance. This allows users to
