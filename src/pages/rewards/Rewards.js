...
export default function Rewards() {
  ...
  return (
    <RootStyle title="Rewards | Nft Marketplace">
      <Container maxWidth="lg">
        ...
        <Typography variant="h5" sx={{ fontWeight: 'normal', color: 'text.secondary', mb: 2 }}>
          ...
          and 10% (10,000,000) respectively of the total NFT Marketplace token supply.
        </Typography>
        <Stack direction="row" spacing={2}>
          <Box sx={{ width: 200 }}>
            ...
            <Typography variant="body2" sx={{ fontWeight: 'normal', color: 'text.secondary', mb: 1 }} align="center">
              {`1 NFT Marketplace ≈ USD ${PASARToUSD.toFixed(4)}`}
            </Typography>
          </Box>
          <Button
            // to={props.to}
        ...
        <TabPanel value={tabValue} index={0}>
          <PaperStyle sx={{ position: 'relative', px: { sm: 5, md: 12 }, py: { sm: 2, md: 5 }, mx: { sm: 2, md: 6 } }}>
            ...
            <Typography variant="body2" component="div" sx={{ lineHeight: 1.1, py: 2 }}>
              Once a buy transaction is completed, the <PinkLabel text="Nft Marketplace" /> mining rewards will be distributed
              accordingly. Mining rewards to earn <PinkLabel text="Nft Marketplace" /> will last 4 years.
              <br />
              <br />
            ...
            <AccordionDetails>
              ...
              <Grid container spacing={2}>
                ...
                <MHidden width="mdUp">
                  <Grid item xs={12}>
                    <Stack direction="row" alignItems="center">
                      <Typography variant="body2">NFT Marketplace in wallet:</Typography>&nbsp;
                ...
                <MHidden width="mdDown">
                  <Grid item sm={4}>
                    <Box textAlign="right">
                      <Typography variant="body1">NFT Marketplace in wallet:</Typography>
                      <EarnedValueStyle variant="h6" sx={{ display: 'inline-flex' }}>
                        {(pasarBalance / 1e18).toFixed(4)}
                      </EarnedValueStyle>
