      ...
      <DialogContent sx={{ display: 'grid' }}>
        ...
        >
          <Typography variant="subtitle1">
            The NFT Marketplace team is not liable for any losses resulting from using services provided by NFT Marketplace (and its
          ...
          <Typography variant="body2" component="div">
            <ol style={{ listStyleType: 'number', marginInlineStart: 16, marginBlock: '1em' }}>
              ...
              <li>
                ...
                foreseen by the NFT Marketplace team, and regardless of whether the NFT Marketplace team has been notified of the
                possibilities of such losses or damages in advance
              </li>
              <li>
                Any other losses related to the services provided by the NFT Marketplace platform that are not caused by the Pasar
                team
              </li>
              <li>
                The NFT Marketplace team does not make any explicit or implied guarantees for the use of the services of the Pasar
                ...
                addition, the NFT Marketplace team does not make any promises or guarantees regarding the validity, accuracy,
                correctness, reliability, quality, stability, completeness, or timeliness of the technology and
                information relating to the services provided by the NFT Marketplace platform. Using the services provided by this
                platform is a personal choice taken by users at their own risk. The NFT Marketplace team does not make any
          ...
          <Typography variant="subtitle1">
            The NFT Marketplace team does not provide any evaluation or comments as to whether the services provided by NFT Marketplace (and
        ...
        <Stack direction="row" sx={{ py: 2 }}>
          <Box sx={{ display: 'flex', flex: 1 }}>
            <FormControlLabel
              ...
              label="I've read, understood and agreed to NFT Marketplace service agreement"
            />
          </Box>
