    ...
    <AppBar sx={{ boxShadow: 0, bgcolor: 'transparent' }}>
      <Collapse in={openTopAlert}>
        <Alert
          ...
          sx={{ borderRadius: 0 }}
        >
          If you have any existing NFTs listed on the old marketplace contract (V1), we encourage you to relist
          them on the new marketplace contract (NFT Marketplace V2).
        </Alert>
      </Collapse>
      <ToolbarStyle
        disableGutters
      ...
      >
        ...
        >
          {isHome ? (
            <Box draggable={false} component="img" src={logo} sx={{ minWidth: 140, width: 140 }} />
          ) : (
            <>
              <MHidden width="mdUp">
                <Searchbar />
